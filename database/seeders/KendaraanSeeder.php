...
class KendaraanSeeder extends Seeder
{
    ...
    {
        Kendaraan::create([
            'nama_kendaraan' => 'Toyota Avanza 1.5 G',
        ...
        Kendaraan::create([
            'nama_kendaraan' => 'Daihatsu Xenia 1.5 R',
            'plat_nomor' => 'B 2345 DE',
            'jenis' => 'mpv',
            'warna' => 'Silver',
            'tahun' => 2023,
            'kapasitas' => 7,
            'harga_sewa_per_hari' => 350000,
            'gambar' => 'kendaraan/xenia.jpg',
            'deskripsi' => 'Daihatsu Xenia 1.5 R dengan kabin luas dan irit bahan bakar, cocok untuk perjalanan jauh.',
            'status' => 'tersedia',
        ]);

        Kendaraan::create([
            'nama_kendaraan' => 'Toyota Innova Reborn 2.4',
