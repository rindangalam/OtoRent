    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/20 p-6">
        <form method="POST" action="{{ route('admin.driver.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="alamat" rows="3" required class="w-full px-4 py-2.5 border-outline-variant/30 focus:ring-2 focus:ring-primary/20 rounded-xl text-body-md outline-none transition">{{ old('alamat') }}</textarea>
