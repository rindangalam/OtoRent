...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="{{ route('admin.driver.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-secondary-container text-on-secondary-container text-label-md rounded-xl transition">
        ...
        <div class="overflow-x-auto">
            @if($drivers->isEmpty())
                <div class="p-12 text-center">
                    ...
                    <h3 class="text-label-lg text-on-surface-variant mb-1">Belum ada driver</h3>
