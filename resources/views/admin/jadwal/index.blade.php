...
<div class="space-y-6" x-data="{ showForm: false }">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button @click="showForm = !showForm" class="inline-flex items-center gap-2 px-4 py-2.5 bg-secondary-container text-on-secondary-container text-label-md rounded-xl transition">
    ...
    {{-- Inline Add Form --}}
    <div x-show="showForm" x-transition x-cloak class="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/20 p-6">
        ...
        <form method="POST" action="{{ route('admin.jadwal.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                    ...
                    <select name="driver_id" required class="w-full px-4 py-2.5 border-outline-variant/30 focus:ring-2 focus:ring-primary/20 rounded-xl text-body-md bg-surface-container-lowest outline-none transition">
            ...
            <div class="flex items-center gap-3">
                <button type="submit" class="px-5 py-2.5 bg-secondary-container text-on-secondary-container text-label-md rounded-xl transition">Simpan</button>
                <button type="button" @click="showForm = false" class="px-5 py-2.5 bg-surface-container text-on-surface-variant text-label-md rounded-xl transition">Batal</button>
            </div>
        </form>
    </div>
        ...
        <div class="overflow-x-auto">
            @if($jadwals->isEmpty())
                <div class="p-12 text-center">
                    ...
                    <h3 class="text-label-lg text-on-surface-variant mb-1">Belum ada jadwal</h3>
            ...
            @else
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-outline-variant/10">
                        ...
                        <tr class="hover:bg-surface-container/50" x-data="{ editing: false }">
