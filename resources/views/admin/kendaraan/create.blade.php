    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/20 p-6">
        <form method="POST" action="{{ route('admin.kendaraan.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" required class="w-full px-4 py-2.5 border border-outline-variant/30 focus:ring-2 focus:ring-primary/20 rounded-xl text-body-md bg-surface-container-lowest outline-none transition">{{ old('deskripsi') }}</textarea>
