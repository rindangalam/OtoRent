    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="{{ route('admin.kendaraan.update', $kendaraan) }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                @if($kendaraan->gambar)
                    <div class="mb-3">
                        <img src="{{ asset('storage/uploads/kendaraan/' . $kendaraan->gambar) }}" alt="{{ $kendaraan->nama_kendaraan }}" class="w-32 h-24 object-cover rounded-lg border border-gray-200">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition">{{ old('deskripsi', $kendaraan->deskripsi) }}</textarea>
