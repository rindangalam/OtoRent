        ...
        <form method="POST" action="{{ route('admin.service.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" required placeholder="Jelaskan detail service yang perlu dilakukan..."
                    class="w-full px-4 py-2.5 border border-outline-variant/30 focus:ring-2 focus:ring-primary/20 rounded-xl text-body-md bg-surface-container-lowest outline-none transition">{{ old('deskripsi') }}</textarea>
