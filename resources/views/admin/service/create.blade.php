...
<div class="max-w-3xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Jadwalkan Service</h1>
    </div>
        ...
        <form method="POST" action="{{ route('admin.service.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" required placeholder="Jelaskan detail service yang perlu dilakukan..."
                    class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition">{{ old('deskripsi') }}</textarea>
